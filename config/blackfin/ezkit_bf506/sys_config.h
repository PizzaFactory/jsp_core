...
/*
 * ADSP-BF506に依存せず、ボードへの実装によって決まるパラメータを
 * ここで定義する。
 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME "EZ-KIT Lite BF506"


/*
 *  シリアルポート数の定義
 *  TNUM_SIOP_XXXは、UARTの種別ごとに宣言する。
 *  TNUM_SIOP_UARTはBF506内蔵UARTのうち、PDICが使用するもの。
 *  BF506はUARTをふたつもっているので、2,1か0を宣言する。
...
#define UART1_BAUD_RATE 31250       /* 31250 bps*/
