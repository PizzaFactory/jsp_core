 ...
 *  PLLクロック周波数計算マクロ
 *
 *  変更してはならない。パラメータはsys_config.hで与える。
 */
 ...
 *  SIL_DLY_TIM1は24サイクル。60nS( 400MHz )
 *  SIL_DLY_TIM2は12サイクル。30nS( 400MHz )
 */
...
/*
 *  UARTレジスタの配置境界。ADSP-BF592の内蔵UARTは4バイト周期でレジスタが
 *  並んでいるので、ここには4を指定する。
 */
