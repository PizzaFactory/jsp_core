...
hw_timer_initialize()
{
    ...
    // TAUTORLD               0x00000004
    // TINT                   0x00000008
    *pTCNTL = 0x00000001;                   // TMPWR : power up timer;
    *pTPERIOD = CORECLOCK/1000;         // CORE CLOCK is defined in sys_config.h
    *pTCNTL = 0x00000007;                   // TMPWR | TMREN | TAUTORLD;
#else
    ...
    *pTIMER2_CONFIG = 0x0059; // PERIOD_CNT | OUT_DIS |IRQ_ENA | PWM_OUT ( PWM_OUT, Output Pad disable)
    ...
    *pTIMER2_WIDTH = 1;                 // 0 < width < period
    ...
    // TIMEN1           0x0002
    // TIMEN2           0x0004
    *pTIMER_ENABLE = 0x004;         // TIMEN2 timer2 start
...
hw_timer_int_clear()
{
    ...
    *__pTCNTL = 0x00000007; // TMPWR | TMREN | TAUTORLD;
    ...
    // TIMIL1           0x0002
    // TIMIL2           0x0004
    *pTIMER_STATUS = 0x004; // TIMIL2, Clear interrupt
#endif
    asm("ssync;");
}
...
hw_timer_terminate()
{
    ...
    // TAUTORLD               0x00000004
    // TINT                   0x00000008
    *pTCNTL = 0x00000005;   //TMPWR | TAUTORLD | TINT;      // 停止
    *pTCNTL = 0;                            // パワーダウンモード
#else
    // GPT2(General-purpose timer2)
    // TIMDIS0          0x0001
    // TIMDIS1          0x0002
    // TIMDIS2          0x0004
    *pTIMER_DISABLE = 0x004;            // TIMDIS2, timer2 disable
#endif
    asm("ssync;");
}
