...
/*
 * ADSP-BF548に依存せず、ボードへの実装によって決まるパラメータを
 * ここで定義する。
 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME "EZ-KIT Lite BF548"
 ...
 *  BF548はUARTを4つもっているが、UART2,3は割り込みをサポートしていないので、
 *  ふたつに限定する。よって、2,1か0を宣言する。
