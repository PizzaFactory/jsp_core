...
/*
 * ADSP-BF518に依存せず、ボードへの実装によって決まるパラメータを
 * ここで定義する。
 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME "EZ-KIT Lite BF518 (Silicon Rev 0.0)"


/*
 *  シリアルポート数の定義
 *  TNUM_SIOP_XXXは、UARTの種別ごとに宣言する。
 *  TNUM_SIOP_UARTはBF518内蔵UARTのうち、PDICが使用するもの。
 *  BF518はUARTをふたつもっているので、2,1か0を宣言する。
